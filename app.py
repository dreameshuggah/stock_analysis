...
if ticker_symbol:
    try:
        ...
        with tab1:
            ...
            with m2: metric_card("Forward P/E", f"{info.get('forwardPE', 'N/A')}")
            with m3: metric_card("Trailing P/E", f"{info.get('trailingPE', 'N/A')}")
            with m4: metric_card("Beta", f"{info.get('beta', 'N/A')}")
